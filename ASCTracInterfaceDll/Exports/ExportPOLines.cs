...
namespace ASCTracInterfaceDll.Exports
{
    public class ExportPOLines
    {
        ...
        */
        ...
        private HttpStatusCode BuildExportList(string sqlstr, Dictionary<string, string> paramlist, ref List<ASCTracInterfaceModel.Model.PO.POExportLines> aData, ref string errmsg)
        {
