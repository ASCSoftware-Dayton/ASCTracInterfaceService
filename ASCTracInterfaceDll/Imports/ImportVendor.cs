...
namespace ASCTracInterfaceDll.Imports
{
    public class ImportVendor
    {
        ...
        {
            var myClass = Class1.InitParse("ImportVendor");
            ...
            {
                Class1.WriteException("VendorImport", Newtonsoft.Json.JsonConvert.SerializeObject(aData), OrderNum, ex.ToString(), updstr);
